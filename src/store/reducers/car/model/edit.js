...
export const save = (url, bodyInfo, lineupBodyList, colorBodyList, trimBodyList, discountBodyList, lineupIdList, colorIdList, trimIdList) => async dispatch => {
    const validation = [];
...
export default function create(state = initialState, action) {
    switch (action.type) {
        ...
        case ADD_LINEUP_BODY:
            return {
                ...
                lineupBodyList: [
                    ...
                    {
                        ...action.payload.body,
                        number: state.lineupBodyList.length + 1
                    }
                ]
            };
        case DELETE_LINEUP_BODY:
            return {
                ...state,
                lineupBodyList: state.lineupBodyList.filter(body => body.number !== action.payload.number)
            };
        ...
        case ADD_COLOR_BODY:
            return {
                ...
                colorBodyList: [
                    ...
                    {
                        ...action.payload.body,
                        number: state.colorBodyList.length + 1
                    }
                ]
            };
        case DELETE_COLOR_BODY:
            return {
                ...state,
                colorBodyList: state.colorBodyList.filter(body => body.number !== action.payload.number)
            };
        case SET_COLOR_BODY:
            return {
                ...state,
        ...
        case ADD_TRIM_BODY:
            return {
                ...
                trimBodyList: [
                    ...
                    {
                        ...action.payload.body,
                        number: state.trimBodyList.length + 1
                    }
                ]
            };
        case DELETE_TRIM_BODY:
            return {
                ...state,
                trimBodyList: state.trimBodyList.filter(body => body.number !== action.payload.number)
            };
        case SET_TRIM_BODY:
            return {
                ...state,
