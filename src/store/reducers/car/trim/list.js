    ...
    switch (action.type) {
        ...
        case SET_SEARCH:
            return {
                ...
                searchData: {
                    ...state.searchData,
                    group_id: action.payload.name === 'brand_id' ? null : state.searchData.group_id,
                    model_id: action.payload.name === 'brand_id' || action.payload.name === 'group_id' ? null : state.searchData.model_id,
                    lineup_id: action.payload.name === 'brand_id' || action.payload.name === 'group_id' || action.payload.name === 'model_id' ? null : state.searchData.lineup_id,
