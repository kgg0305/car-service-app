...
export async function CheckQuotationNameAPI(brandName) {
    try {
        const response = await axios.post(process.env.REACT_APP_API_URL + '/quotation/check-name', {
...
export async function CreateQuotationAPI(bodyList) {
    ...
    try {
        const response = await axios.post(process.env.REACT_APP_API_URL + '/quotation', data);
...
export async function UpdateQuotationAPI(body) {
    ...
    try {
        const response = await axios.put(process.env.REACT_APP_API_URL + '/quotation/' + body.idx, data);
...
export async function GetQuotationListAPI(offset, search) {
    try {
        const response = await axios.post(process.env.REACT_APP_API_URL + '/quotation/list/' + offset, search);
...
export async function GetQuotationOptionListAPI(offset, search) {
    try {
        const response = await axios.get(process.env.REACT_APP_API_URL + '/quotation/option-list');
...
export async function GetQuotationInfoAPI(idx) {
    try {
        const response = await axios.get(process.env.REACT_APP_API_URL + '/quotation/' + idx);
...
export async function DeleteQuotationInfoAPI(idx) {
    try {
        const response = await axios.delete(process.env.REACT_APP_API_URL + '/quotation/' + idx);
