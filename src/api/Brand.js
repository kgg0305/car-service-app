...
export async function CheckBrandNameAPI(brandName) {
    try {
        const response = await axios.post('http://13.125.168.233:4200/brand/check-name', {
...
export async function CreateBrandAPI(bodyList) {
    ...
    try {
        const response = await axios.post('http://13.125.168.233:4200/brand', data);
...
export async function UpdateBrandAPI(body) {
    ...
    try {
        const response = await axios.put('http://13.125.168.233:4200/brand/' + body.idx, data);
...
export async function GetBrandListAPI(offset, search) {
    try {
        const response = await axios.post('http://13.125.168.233:4200/brand/list/' + offset, search);
...
export async function GetBrandOptionListAPI(offset, search) {
    try {
        const response = await axios.get('http://13.125.168.233:4200/brand/option-list');
...
export async function GetBrandInfoAPI(idx) {
    try {
        const response = await axios.get('http://13.125.168.233:4200/brand/' + idx);
...
export async function DeleteBrandInfoAPI(idx) {
    try {
        const response = await axios.delete('http://13.125.168.233:4200/brand/' + idx);
