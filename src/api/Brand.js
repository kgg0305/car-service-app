...
export async function CheckBrandNameAPI(brandName) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/brand/check-name",
      {
...
export async function UpdateBrandAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/brand/" + body.idx,
      data
    );
...
export async function GetBrandListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/brand/list/" + offset,
      search
    );
...
export async function GetBrandOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/brand/option-list"
    );
...
export async function GetBrandInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/brand/" + idx
    );
