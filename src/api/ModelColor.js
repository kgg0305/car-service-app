...
export async function CreateModelColorAPI(bodyList) {
  ...
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-color",
      data
    );
...
export async function UpdateModelColorAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/model-color/" + body.idx,
      data
    );
...
export async function GetModelColorListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-color/list/" + offset,
      search
    );
...
export async function GetModelColorOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-color/option-list"
    );
...
export async function GetModelColorInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-color/" + idx
    );
