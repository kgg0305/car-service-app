...
export async function CreateModelGalleryAPI(bodyList) {
  ...
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-gallery",
      data
    );
...
export async function UpdateModelGalleryAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/model-gallery/" + body.idx,
      data
    );
...
export async function GetModelGalleryListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-gallery/list/" + offset,
      search
    );
...
export async function GetModelGalleryOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-gallery/option-list"
    );
...
export async function GetModelGalleryInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-gallery/" + idx
    );
