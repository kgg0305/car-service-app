...
export async function CheckDiscountConditionNameAPI(kind_name) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/discount-condition/check-name",
      {
        kind_name: kind_name,
      }
    );
...
export async function CreateDiscountConditionAPI(startedIndex, bodyList) {
  ...
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/discount-condition",
      data
    );
...
export async function UpdateDiscountConditionAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/discount-condition/" + body.idx,
      data
    );
...
export async function GetDiscountConditionListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/discount-condition/list/" + offset,
      search
    );
...
export async function GetDiscountConditionOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/discount-condition/option-list"
    );
...
export async function GetDiscountConditionInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/discount-condition/" + idx
    );
