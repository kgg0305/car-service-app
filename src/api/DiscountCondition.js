...
export async function CheckDiscountConditionNameAPI(kind_name) {
    try {
        const response = await axios.post('http://13.125.168.233:4200/discount-condition/check-name', {
            kind_name: kind_name
        });
...
export async function CreateDiscountConditionAPI(startedIndex, bodyList) {
    ...
    try {
        const response = await axios.post('http://13.125.168.233:4200/discount-condition', data);
...
export async function UpdateDiscountConditionAPI(body) {
    ...
    try {
        const response = await axios.put('http://13.125.168.233:4200/discount-condition/' + body.idx, data);
...
export async function GetDiscountConditionListAPI(offset, search) {
    try {
        const response = await axios.post('http://13.125.168.233:4200/discount-condition/list/' + offset, search);
...
export async function GetDiscountConditionOptionListAPI(offset, search) {
    try {
        const response = await axios.get('http://13.125.168.233:4200/discount-condition/option-list');
...
export async function GetDiscountConditionInfoAPI(idx) {
    try {
        const response = await axios.get('http://13.125.168.233:4200/discount-condition/' + idx);
...
export async function DeleteDiscountConditionInfoAPI(idx) {
    try {
        const response = await axios.delete('http://13.125.168.233:4200/discount-condition/' + idx);
