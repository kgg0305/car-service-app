...
export async function CheckDiscountKindNameAPI(kind_name) {
    try {
        const response = await axios.post('http://127.0.0.1:3001/discount-kind/check-name', {
            kind_name: kind_name
        });
...
export async function CreateDiscountKindAPI(bodyList) {
    ...
    try {
        const response = await axios.post('http://127.0.0.1:3001/discount-kind', data);
...
export async function UpdateDiscountKindAPI(body) {
    ...
    try {
        const response = await axios.put('http://127.0.0.1:3001/discount-kind/' + body.idx, data);
...
export async function GetDiscountKindListAPI(offset, search) {
    try {
        const response = await axios.post('http://127.0.0.1:3001/discount-kind/list/' + offset, search);
...
export async function GetDiscountKindOptionListAPI(offset, search) {
    try {
        const response = await axios.get('http://127.0.0.1:3001/discount-kind/option-list');
...
export async function GetDiscountKindInfoAPI(idx) {
    try {
        const response = await axios.get('http://127.0.0.1:3001/discount-kind/' + idx);
...
export async function DeleteDiscountKindInfoAPI(idx) {
    try {
        const response = await axios.delete('http://127.0.0.1:3001/discount-kind/' + idx);
