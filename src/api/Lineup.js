...
export async function CheckLineupNameAPI(lineup_name) {
    try {
        const response = await axios.post('http://127.0.0.1:3001/lineup/check-name', {
...
export async function CreateLineupAPI(body) {
    ...
    try {
        const response = await axios.post('http://127.0.0.1:3001/lineup', data);
...
export async function UpdateLineupAPI(body) {
    ...
    try {
        const response = await axios.put('http://127.0.0.1:3001/lineup/' + body.idx, data);
...
export async function GetLineupListAPI(offset, search) {
    try {
        const response = await axios.post('http://127.0.0.1:3001/lineup/list/' + offset, search);
...
export async function GetLineupOptionListAPI(offset, search) {
    try {
        const response = await axios.get('http://127.0.0.1:3001/lineup/option-list');
...
export async function GetLineupInfoAPI(idx) {
    try {
        const response = await axios.get('http://127.0.0.1:3001/lineup/' + idx);
...
export async function DeleteLineupInfoAPI(idx) {
    try {
        const response = await axios.delete('http://127.0.0.1:3001/lineup/' + idx);
