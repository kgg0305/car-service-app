...
export async function CheckLineupNameAPI(lineup_name) {
    try {
        const response = await axios.post(process.env.REACT_APP_API_URL + '/lineup/check-name', {
...
export async function CreateLineupAPI(body) {
    ...
    try {
        const response = await axios.post(process.env.REACT_APP_API_URL + '/lineup', data);
...
export async function UpdateLineupAPI(body) {
    ...
    try {
        const response = await axios.put(process.env.REACT_APP_API_URL + '/lineup/' + body.idx, data);
...
export async function GetLineupListAPI(offset, search) {
    try {
        const response = await axios.post(process.env.REACT_APP_API_URL + '/lineup/list/' + offset, search);
...
export async function GetLineupOptionListAPI(offset, search) {
    try {
        const response = await axios.get(process.env.REACT_APP_API_URL + '/lineup/option-list');
...
export async function GetLineupInfoAPI(idx) {
    try {
        const response = await axios.get(process.env.REACT_APP_API_URL + '/lineup/' + idx);
...
export async function DeleteLineupInfoAPI(idx) {
    try {
        const response = await axios.delete(process.env.REACT_APP_API_URL + '/lineup/' + idx);
