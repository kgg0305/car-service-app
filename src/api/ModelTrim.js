...
export async function CreateModelTrimAPI(bodyList) {
  ...
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-trim",
      data
    );
...
export async function UpdateModelTrimAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/model-trim/" + body.idx,
      data
    );
...
export async function GetModelTrimListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-trim/list/" + offset,
      search
    );
...
export async function GetModelTrimOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-trim/option-list"
    );
...
export async function GetModelTrimInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-trim/" + idx
    );
