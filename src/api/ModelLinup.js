...
export async function CreateModelLineupAPI(bodyList) {
  ...
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-lineup",
      data
    );
...
export async function UpdateModelLineupAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/model-lineup/" + body.idx,
      data
    );
...
export async function GetModelLineupListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model-lineup/list/" + offset,
      search
    );
...
export async function GetModelLineupOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-lineup/option-list"
    );
...
export async function GetModelLineupInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model-lineup/" + idx
    );
