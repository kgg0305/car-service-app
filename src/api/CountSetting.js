...
export async function CheckCountSettingNameAPI(group_name) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/count-setting/check-name",
      {
...
export async function CreateCountSettingAPI(bodyList) {
  ...
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/count-setting",
      data
    );
...
export async function UpdateCountSettingAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/count-setting/" + body.idx,
      data
    );
...
export async function GetCountSettingListAPI() {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/count-setting/list"
    );
...
export async function GetCountSettingOptionListAPI() {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/count-setting/option-list"
    );
...
export async function GetCountSettingInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/count-setting/" + idx
    );
