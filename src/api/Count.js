...
export async function CheckCountNameAPI(brandName) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/count/check-name",
      {
...
export async function UpdateCountAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/count/" + body.idx,
      data
    );
...
export async function GetCountListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/count/list/" + offset,
      search
    );
...
export async function GetCountOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/count/option-list"
    );
...
export async function GetCountInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/count/" + idx
    );
...
export async function GetCountInfoByDateAPI(date) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/count/info-by-date/" + date
    );
