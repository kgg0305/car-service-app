...
export async function CheckModelNameAPI(model_name) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model/check-name",
      {
...
export async function UpdateModelAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/model/" + body.idx,
      data
    );
...
export async function GetModelListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/model/list/" + offset,
      search
    );
...
export async function GetModelOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model/option-list"
    );
...
export async function GetModelInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/model/" + idx
    );
