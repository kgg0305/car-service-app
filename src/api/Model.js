...
export async function CheckModelNameAPI(model_name) {
    try {
        const response = await axios.post('http://127.0.0.1:3001/model/check-name', {
...
export async function CreateModelAPI(body) {
    ...
    try {
        const response = await axios.post('http://127.0.0.1:3001/model', data);
...
export async function UpdateModelAPI(body) {
    ...
    try {
        const response = await axios.put('http://127.0.0.1:3001/model/' + body.idx, data);
...
export async function GetModelListAPI(offset, search) {
    try {
        const response = await axios.post('http://127.0.0.1:3001/model/list/' + offset, search);
...
export async function GetModelOptionListAPI(offset, search) {
    try {
        const response = await axios.get('http://127.0.0.1:3001/model/option-list');
...
export async function GetModelInfoAPI(idx) {
    try {
        const response = await axios.get('http://127.0.0.1:3001/model/' + idx);
...
export async function DeleteModelInfoAPI(idx) {
    try {
        const response = await axios.delete('http://127.0.0.1:3001/model/' + idx);
