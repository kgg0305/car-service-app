...
export async function CheckExtraNameAPI(region) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/extra/check-name",
      {
        region: region,
      }
    );
...
export async function CreateExtraAPI(body) {
  ...
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/extra",
      data
    );
...
export async function UpdateExtraAPI(body) {
  ...
  try {
    const response = await axios.put(
      process.env.REACT_APP_API_URL + "/extra/" + body.idx,
      data
    );
...
export async function GetExtraListAPI(offset, search) {
  try {
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "/extra/list/" + offset,
      search
    );
...
export async function GetExtraOptionListAPI(offset, search) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/extra/option-list"
    );
...
export async function GetExtraInfoAPI(idx) {
  try {
    const response = await axios.get(
      process.env.REACT_APP_API_URL + "/extra/" + idx
    );
...
export async function DownloadExtraFileAPI() {
  try {
    const response = await axios
      .post(process.env.REACT_APP_API_URL + "/extra/download", null, {
        headers: {
