...
import {
  ...
  showConfirm,
  remove,
} from "../../../store/reducers/content/contentRank/create";
...
function Create() {
  ...
  const { redirectTo, validation, confirm, bodyInfo, contentBodyList } =
    useSelector((state) => ({
      redirectTo: state.contentRankCreate.redirectTo,
      validation: state.contentRankCreate.validation,
      confirm: state.contentRankCreate.confirm,
      bodyInfo: state.contentRankCreate.bodyInfo,
      contentBodyList: state.contentRankCreate.contentBodyList,
    }));
