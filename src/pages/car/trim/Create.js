...
function Create() {
  ...
  const {
    ...
    redirectTo: state.trimCreate.redirectTo,
    validation: state.trimCreate.validation,
    brandOptionList: state.trimCreate.brandOptionList,
    groupOptionList: state.trimCreate.groupOptionList,
    modelOptionList: state.trimCreate.modelOptionList,
    lineupOptionList: state.trimCreate.lineupOptionList,
    bodyInfo: state.trimCreate.bodyInfo,
    brandBodyInfo: state.trimCreate.brandBodyInfo,
    lineupBodyInfo: state.trimCreate.lineupBodyInfo,
    specificationBodyList: state.trimCreate.specificationBodyList,
    trimBodyList: state.trimCreate.trimBodyList,
    detailBodyInfo: state.trimCreate.detailBodyInfo,
  }));
  ...
  const onSpecificationComponentChange = (number, name, value) =>
  ...
  const onTrimComponentChange = (idx, name, value) =>
            ...
            <Col>
              <Space size={6}>
                <Select
                  ...
                  onChange={(value) => {
                    onSpecificationComponentChange(
                      body.number,
                      "specification_id",
                      value
                    );
